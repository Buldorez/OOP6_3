...
namespace ООП_6_3
{
    class Program
    {
        ...
        {
            treugolnik zn = new treugolnik(9, 8, 7);
            Console.WriteLine("\n");
            treugolnik zn2 = new treugolnik(15, 4, 3);
    ...
    class treugolnik
    {
        ...
        public double b;
        public double c;
        public treugolnik(int line1, int line2, int line3)
        {
            ...
            if ((a + b > c) && (b + c > a) && (c + a > b))
            {
                ...
                Console.WriteLine("Треуголник нельзя построить");
